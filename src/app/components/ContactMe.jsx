	...
	return (
		<Box
			...
			<Box ml={{ md: "5rem", base: "2rem" }} mt={"2rem"}>
				<Heading fontSize={{ md: "48px", base: "20px" }}>
				...
				<Text
					...
					Offer me the chance at your company <br /> or as a freelance agent and
					lets <br /> put creativity together to create products <br /> that
					solves problems and generates <br /> revenue..
				</Text>
			</Box>
			<Link
